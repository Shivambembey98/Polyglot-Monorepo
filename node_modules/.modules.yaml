...
hoistedDependencies:
  ...
  /@angular-devkit/build-angular/18.2.20(@angular/compiler-cli@18.2.13)(karma@6.4.4)(typescript@5.5.4):
    '@angular-devkit/build-angular': private
  /@angular-devkit/build-webpack/0.1802.20(webpack-dev-server@5.2.2)(webpack@5.94.0):
  ...
  /@angular-eslint/builder/18.4.3(eslint@8.57.1)(typescript@5.5.4):
    '@angular-eslint/builder': public
  /@angular-eslint/bundled-angular-compiler/18.4.3:
    '@angular-eslint/bundled-angular-compiler': public
  /@angular-eslint/eslint-plugin-template/18.4.3(@typescript-eslint/types@8.35.0)(@typescript-eslint/utils@8.35.0)(eslint@8.57.1)(typescript@5.5.4):
    '@angular-eslint/eslint-plugin-template': public
  /@angular-eslint/eslint-plugin/18.4.3(@typescript-eslint/utils@8.35.0)(eslint@8.57.1)(typescript@5.5.4):
    '@angular-eslint/eslint-plugin': public
  /@angular-eslint/template-parser/18.4.3(eslint@8.57.1)(typescript@5.5.4):
    '@angular-eslint/template-parser': public
  /@angular-eslint/utils/18.4.3(@typescript-eslint/utils@8.35.0)(eslint@8.57.1)(typescript@5.5.4):
    '@angular-eslint/utils': public
  /@angular-slider/ngx-slider/18.0.0(@angular/common@18.2.13)(@angular/core@18.2.13)(@angular/forms@18.2.13):
    '@angular-slider/ngx-slider': private
  /@angular/animations/18.2.13(@angular/core@18.2.13):
    '@angular/animations': private
  /@angular/build/18.2.20(@angular/compiler-cli@18.2.13)(less@4.2.0)(postcss@8.4.41)(terser@5.31.6)(typescript@5.5.4):
    '@angular/build': private
  /@angular/cdk/18.2.14(@angular/common@18.2.13)(@angular/core@18.2.13)(rxjs@7.8.2):
    '@angular/cdk': private
  /@angular/cli/18.2.20:
    '@angular/cli': private
  /@angular/common/18.2.13(@angular/core@18.2.13)(rxjs@7.8.2):
    '@angular/common': private
  /@angular/compiler-cli/18.2.13(@angular/compiler@18.2.13)(typescript@5.5.4):
    '@angular/compiler-cli': private
  /@angular/compiler/18.2.13(@angular/core@18.2.13):
    '@angular/compiler': private
  /@angular/core/18.2.13(rxjs@7.8.2)(zone.js@0.14.10):
    '@angular/core': private
  /@angular/forms/18.2.13(@angular/common@18.2.13)(@angular/core@18.2.13)(@angular/platform-browser@18.2.13)(rxjs@7.8.2):
    '@angular/forms': private
  /@angular/material/18.2.14(@angular/animations@18.2.13)(@angular/cdk@18.2.14)(@angular/common@18.2.13)(@angular/core@18.2.13)(@angular/forms@18.2.13)(@angular/platform-browser@18.2.13)(rxjs@7.8.2):
    '@angular/material': private
  /@angular/platform-browser-dynamic/18.2.13(@angular/common@18.2.13)(@angular/compiler@18.2.13)(@angular/core@18.2.13)(@angular/platform-browser@18.2.13):
    '@angular/platform-browser-dynamic': private
  /@angular/platform-browser/18.2.13(@angular/animations@18.2.13)(@angular/common@18.2.13)(@angular/core@18.2.13):
    '@angular/platform-browser': private
  /@angular/router/18.2.13(@angular/common@18.2.13)(@angular/core@18.2.13)(@angular/platform-browser@18.2.13)(rxjs@7.8.2):
  ...
  /@ng-select/ng-select/14.9.0(@angular/common@18.2.13)(@angular/core@18.2.13)(@angular/forms@18.2.13):
    '@ng-select/ng-select': private
  /@ngtools/webpack/18.2.20(@angular/compiler-cli@18.2.13)(typescript@5.5.4)(webpack@5.94.0):
  ...
  /@typescript-eslint/eslint-plugin/8.35.0(@typescript-eslint/parser@8.35.0)(eslint@8.57.1)(typescript@5.5.4):
  ...
  /@vitejs/plugin-basic-ssl/1.1.0(vite@5.4.19):
  ...
  /eslint-module-utils/2.12.1(@typescript-eslint/parser@8.35.0)(eslint-import-resolver-node@0.3.9)(eslint@8.57.1):
    eslint-module-utils: public
  /eslint-plugin-import/2.32.0(@typescript-eslint/parser@8.35.0)(eslint@8.57.1):
  ...
  /karma-jasmine-html-reporter/2.1.0(jasmine-core@5.2.0)(karma-jasmine@5.1.0)(karma@6.4.4):
  ...
  /neo-async/2.6.2:
    neo-async: private
  /ngx-bootstrap/19.0.2(@angular/animations@18.2.13)(@angular/common@18.2.13)(@angular/core@18.2.13)(@angular/forms@18.2.13)(rxjs@7.8.2):
    ngx-bootstrap: private
  /ngx-intl-tel-input/17.0.0(@angular/common@18.2.13)(@angular/core@18.2.13)(@angular/forms@18.2.13)(google-libphonenumber@3.2.42)(intl-tel-input@19.5.7)(ngx-bootstrap@19.0.2):
    ngx-intl-tel-input: private
  /ngx-skeleton-loader/10.0.0(@angular/common@18.2.13)(@angular/core@18.2.13):
  ...
  /vary/1.1.2:
    vary: private
  /vite/5.4.19(less@4.2.0)(sass@1.77.6)(terser@5.31.6):
    vite: private
  /void-elements/2.0.1:
...
pendingBuilds: []
prunedAt: Mon, 30 Jun 2025 12:52:37 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
